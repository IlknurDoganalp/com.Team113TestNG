package tests.day17_xmlsFilesTestNGReports;
...
public class C01_ReusableMethodsSwitchingWindow {
    ...
    public void test01() throws InterruptedException {
        ...
        SoftAssert softAssert = new SoftAssert(); // softaseert ile yapacaksak mutlaka yeni obje olusturmaliyiz
        ...
        ReusableMethods.switchToWindow("New Window");// yeni sayfa acmak icin yazilan kod
